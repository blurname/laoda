          ...
          {isImporting ? (
            <>
              <button 
                ...
                className="px-3 py-1 text-[9px] font-black capitalize tracking-widest text-zinc-500 hover:text-zinc-700"
              >
                Cancel
              </button>
              <button 
                onClick={handleImport}
                className="px-3 py-1 bg-zinc-700 text-zinc-100 text-[9px] font-black capitalize tracking-widest border border-zinc-800 shadow-sm active:bg-zinc-800 active:shadow-none transition-all"
              >
                Confirm_Import
              </button>
            </>
